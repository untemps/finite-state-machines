...
const Presentation = () => (
	<Deck theme={theme} template={template} transitionEffect="fade">
		<Slide>
			<FlexBox height="100%" flexDirection="column">
				<Image src="./images/alive-kitten.png" width="18%" />
				<Image src="./images/warning-sign.png" width="10%" position="absolute" left="34%" top="32%" />
		...
		<Slide backgroundColor="secondary">
			...
			>
				<Image src="./images/alive-kitten.png" width={3 / 7} />
				<Image src="./images/dead-kitten.png" width={3 / 7} />
			</FlexBox>
			<Notes>
				<Text>
		...
		<Slide>
			<FlexBox
				...
				justifyContent="space-between"
			>
				<Image src="./images/traffic-light-model.png" />
		...
		<Slide>
			...
			>
				...
				<Image src="./images/water-model.png" />
			</FlexBox>
		</Slide>
		<Slide>
			<FlexBox
				...
				justifyContent="space-between"
			>
				<Image src="./images/promise-model.png" />
	...
	rejected: {}
		...
		<Slide>
			...
			<Notes>
				<FlexBox flexDirection="column" alignItems="flex-start" mt={80}>
					<Link href="https://medium.com/datadriveninvestor/state-machine-design-pattern-why-how-example-through-spring-state-machine-part-1-f13872d68c2d">
						State Machine Design pattern —Part 1: When, Why & How - Kousik Nath
					</Link>
				</FlexBox>
			</Notes>
		...
		<Slide>
			<FlexBox
				...
				justifyContent="space-between"
			>
				<Image src="./images/state-explosion-before.png" width={3/7} />
				<Image src="./images/state-explosion-after.png" width={3/7} />
			</FlexBox>
			<Notes>
...
const nextState = machine.transition('pending', 'resolve')`}
		...
		<Slide>
			<FlexBox height="100%" flexDirection="column">
				<Image src="./images/dead-kitten.png" width="18%" />
